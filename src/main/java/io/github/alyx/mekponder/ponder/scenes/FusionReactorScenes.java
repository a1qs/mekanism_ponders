...
public class FusionReactorScenes {
    public static void constructingReactor(SceneBuilder scene, SceneBuildingUtil util) {
        scene.title(MekGensPonderScenes.CONSTRUCTING_FUSION_REACTOR.getPath(), "Constructing a Fusion Reactor");
        scene.showBasePlate();
        scene.idle(10);
    ...
    public static void configuringReactor(SceneBuilder scene, SceneBuildingUtil util) {
        scene.title(MekGensPonderScenes.CONFIGURING_FUSION_REACTOR.getPath(), "Configuring a Fusion Reactor");
    ...
    public static void startingReactor(SceneBuilder scene, SceneBuildingUtil util) {
        scene.title(MekGensPonderScenes.STARTING_FUSION_REACTOR.getPath(), "Starting a Fusion Reactor");
    ...
    public static void fuelingReactor(SceneBuilder scene, SceneBuildingUtil util) {
        scene.title(MekGensPonderScenes.FUELING_FUSION_REACTOR.getPath(), "Fueling a Fusion Reactor");
